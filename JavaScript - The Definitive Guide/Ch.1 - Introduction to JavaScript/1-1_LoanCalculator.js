...
<table>
    ...
    <tr><td>Zipcode (to find lenders):</td>
        <input id="zipcode" onchange="calculate();"></td>
    ...
    <tr><th>Sponsors:</td><td colspan=2>
...
// run the example from a local file:// URL. It does not work over HTTP, however. 
...
window.onload = function() {
    // If the brower supports localStorage and we have some stored data
...
function getLenders(amount, apr, years, zipcode) {
    ...
    // Encode the user's input as query parameters as URL
...
function char(principal, interest, monthly, payments) {
    ...
    // If we're called with no arguments, or if thise browser does not support
    ...
    g.moveToaaa(paymentToX(0), amountToY(0));      // starting at lower-left
